...
class PyhandleException(Exception): 
    pass

class BrokenHandleRecordException(PyhandleException):
...
class IllegalOperationException(PyhandleException):
    '''
...
class GenericHandleError(PyhandleException):
    '''
...
class ReverseLookupException(PyhandleException):
    '''
...
class HandleNotFoundException(PyhandleException):
    '''
...
class HandleSyntaxError(PyhandleException):
    '''
...
class HandleAlreadyExistsException(PyhandleException):
    '''
...
class HandleAuthenticationError(PyhandleException):
    '''
...
class CredentialsFormatError(PyhandleException):
    '''
